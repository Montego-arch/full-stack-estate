...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountPrice) return setError('Discount price must belower than regular price');
            setLoading(true);
            setError(false);
        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <span className='font-normal text-gray-600 ml-2'>The first image is gonna be the cover (max-6)</span>
                    </p>

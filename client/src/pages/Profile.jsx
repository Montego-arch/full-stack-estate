  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder="username" defaultValue={currentUser.username} id='username' class="border p-3 rounded-lg" onChange={handleChange}/>
        <input type="text" placeholder="email" defaultValue={currentUser.email} id='email' class="border p-3 rounded-lg" onChange={handleChange}/>
        <input type="password" placeholder="password" id='password' class="border p-3 rounded-lg" onChange={handleChange}/>
        <button disabled={loading} 
        className='bg-slate-700 text-white rounded-lg p-3 uppercase
        hover:opacity-95 disabled:op80'>
      ...
      <p className='text-green-700 mt-5'>
        {updateSuccess ? 'User is update Successfully!!' : ''}</p>
      ...
      {userListings && 
        ...
        <div className="flex flex-col gap-4">
          ...
          p-3 flex justify-between items-center gap-4'>
            ...
            hover:underline truncate flex-1' to={`/listing/
            ${listing._id}`}>
              <p>{listing.name}</p>
            </Link>

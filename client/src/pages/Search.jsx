...
export default function Search() {
    ...
    const [sidebardata, setSidebrdata] = useState({
        searchTerm: '',
        type: 'all',
        parking: false,
        offer: false,
    ...
    const handleChange = (e) => {
        ...
        if(
            ...
            e.target.id === 'rent' ||
            e.target.id === 'sale'){
            setSidebrdata({...sidebardata, type: e.target.id})
        }

        if(e.target.id === 'searchTerm'){
            setSidebrdata({...sidebardata, searchTerm: e.target.value})
        }
        ...
        if (e.target.id === 'sort_order') {
            ...
            setSidebrdata({ ...sidebardata, sort, order })
        }
    };
        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex gap-2 flex-wrap
                 items-center'>
                    <label className='font font-semibold'>Type:</label>
